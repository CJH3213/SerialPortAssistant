...
public:
    ...
    void setupUi(QWidget *ParameterAdjustmentItem)
    {
        ...
        ParameterAdjustmentItem->resize(220, 100);
        ParameterAdjustmentItem->setMinimumSize(QSize(220, 100));
        ...
        horizontalLayout_5->addWidget(label_3, 0, Qt::AlignmentFlag::AlignLeft);
