...
public:
    ...
    void setupUi(QWidget *ReceiveChart)
    {
        ...
        gridLayout_2->addWidget(mRunOrStopButton, 0, 1, 1, 1, Qt::AlignmentFlag::AlignHCenter);
        ...
        gridLayout_2->addWidget(mSingleButton, 1, 1, 1, 1, Qt::AlignmentFlag::AlignHCenter);
        ...
        gridLayout_2->addWidget(mDirectOrDecodeButton, 0, 0, 1, 1, Qt::AlignmentFlag::AlignHCenter|Qt::AlignmentFlag::AlignVCenter);
        ...
        gridLayout->addWidget(label_3, 0, 2, 1, 1, Qt::AlignmentFlag::AlignHCenter);
        ...
        verticalLayout_8->addWidget(label_6, 0, Qt::AlignmentFlag::AlignHCenter);
        ...
        mVerticalPositionDial->setContextMenuPolicy(Qt::ContextMenuPolicy::NoContextMenu);
        ...
        verticalLayout_8->addWidget(mVerticalPositionDial, 0, Qt::AlignmentFlag::AlignHCenter);
        ...
        mVerticalPositionLineEdit->setAlignment(Qt::AlignmentFlag::AlignCenter);

        verticalLayout_8->addWidget(mVerticalPositionLineEdit, 0, Qt::AlignmentFlag::AlignHCenter);
        ...
        verticalLayout_9->addWidget(label_2, 0, Qt::AlignmentFlag::AlignHCenter);
        ...
        mHorizontalScaleDial->setContextMenuPolicy(Qt::ContextMenuPolicy::NoContextMenu);
        mHorizontalScaleDial->setMaximum(1000);
        mHorizontalScaleDial->setValue(10);
        mHorizontalScaleDial->setSliderPosition(10);
        mHorizontalScaleDial->setWrapping(true);

        verticalLayout_9->addWidget(mHorizontalScaleDial, 0, Qt::AlignmentFlag::AlignHCenter);
        ...
        mHorizontalScaleLineEdit->setAlignment(Qt::AlignmentFlag::AlignCenter);

        verticalLayout_9->addWidget(mHorizontalScaleLineEdit, 0, Qt::AlignmentFlag::AlignHCenter);
        ...
        mVerticalScaleDial->setContextMenuPolicy(Qt::ContextMenuPolicy::NoContextMenu);
        ...
        verticalLayout_7->addWidget(mVerticalScaleDial, 0, Qt::AlignmentFlag::AlignHCenter);
        ...
        mVerticalScaleLineEdit->setAlignment(Qt::AlignmentFlag::AlignCenter);

        verticalLayout_7->addWidget(mVerticalScaleLineEdit, 0, Qt::AlignmentFlag::AlignHCenter);
        ...
        verticalLayout_10->addWidget(label_7, 0, Qt::AlignmentFlag::AlignHCenter);
        ...
        mHorizontalPositionDial->setContextMenuPolicy(Qt::ContextMenuPolicy::NoContextMenu);
        mHorizontalPositionDial->setMinimum(-100);
        mHorizontalPositionDial->setMaximum(100);
        mHorizontalPositionDial->setWrapping(true);

        verticalLayout_10->addWidget(mHorizontalPositionDial, 0, Qt::AlignmentFlag::AlignHCenter);
        ...
        mHorizontalPositionLineEdit->setAlignment(Qt::AlignmentFlag::AlignCenter);

        verticalLayout_10->addWidget(mHorizontalPositionLineEdit, 0, Qt::AlignmentFlag::AlignHCenter);
    ...
    {
        ReceiveChart->setWindowTitle(QCoreApplication::translate("ReceiveChart", "\344\270\262\345\217\243\347\244\272\346\263\242\345\231\250", nullptr));
